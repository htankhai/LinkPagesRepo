...
public class HelloWorldServiceLocator extends org.apache.axis.client.Service implements org.soapHelloWorld.HelloWorldService {
    ...
    private java.lang.String HelloWorld_address = "http://localhost:8080/SoapWebHelloWorld/services/HelloWorld";
    ...
    public org.soapHelloWorld.HelloWorld getHelloWorld() throws javax.xml.rpc.ServiceException {
    ...
    public org.soapHelloWorld.HelloWorld getHelloWorld(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            org.soapHelloWorld.HelloWorldSoapBindingStub _stub = new org.soapHelloWorld.HelloWorldSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (org.soapHelloWorld.HelloWorld.class.isAssignableFrom(serviceEndpointInterface)) {
                org.soapHelloWorld.HelloWorldSoapBindingStub _stub = new org.soapHelloWorld.HelloWorldSoapBindingStub(new java.net.URL(HelloWorld_address), this);
                _stub.setPortName(getHelloWorldWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://soapHelloWorld.org", "HelloWorldService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://soapHelloWorld.org", "HelloWorld"));
        }
