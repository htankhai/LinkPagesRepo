...
<jsp:useBean id="sampleHelloWorldProxyid" scope="session" class="org.soapHelloWorld.HelloWorldProxy" />
<%
...
case 10:
        gotMethod = true;
        org.soapHelloWorld.HelloWorld getHelloWorld10mtemp = sampleHelloWorldProxyid.getHelloWorld();
...
case 13:
        gotMethod = true;
        String txt_1id=  request.getParameter("txt16");
            java.lang.String txt_1idTemp = null;
        if(!txt_1id.equals("")){
         txt_1idTemp  = txt_1id;
        }
        java.lang.String hello13mtemp = sampleHelloWorldProxyid.hello(txt_1idTemp);
